...
if __name__ == '__main__':
    ...
    parser.add_argument("--desired_vis", type=float, default=-1)
    parser.add_argument("--cons",type=str,default='eq')
    parser.add_argument("--velo",type=int,default=1)
